...
const Filter = ({
  ...
  },source, width, height, left, right,top }) => {
  ...
  return (
    <View
      style={{position: "absolute",left: leftEyePosition.x - filterWidth * left,right: rightEyePosition.x - filterWidth * right,top: noseBasePosition.y - filterHeight * top}}>
      <Image
        source={source} style={{
          width: filterWidth,
          height: filterHeight,
